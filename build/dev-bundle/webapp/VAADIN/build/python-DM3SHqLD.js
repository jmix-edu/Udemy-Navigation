import{g as c}from"./generated-flow-imports-DCXOKDeO.js";function $(p,i){for(var n=0;n<i.length;n++){const t=i[n];if(typeof t!="string"&&!Array.isArray(t)){for(const e in t)if(e!=="default"&&!(e in p)){const o=Object.getOwnPropertyDescriptor(t,e);o&&Object.defineProperty(p,e,o.get?o:{enumerable:!0,get:()=>t[e]})}}}return Object.freeze(Object.defineProperty(p,Symbol.toStringTag,{value:"Module"}))}var r={exports:{}};(function(p,i){ace.define("ace/snippets/python.snippets",["require","exports","module"],function(n,t,e){e.exports=`snippet #!
	#!/usr/bin/env python
snippet imp
	import \${1:module}
snippet from
